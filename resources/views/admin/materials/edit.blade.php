...
<div class="container mx-auto px-4 py-8">
    <h1 class="text-3xl font-bold mb-6">Edit Materi: {{ $course->title }}</h1>
    ...
    <form action="{{ route('admin.courses.materials.update', ['course' => $course->id, 'material' => $material->id]) }}" method="POST">
    @csrf
    @method('PUT')
