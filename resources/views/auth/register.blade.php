...
<body class="flex items-center justify-center min-h-screen bg-cover bg-center" 
        ...
        <form method="POST" action="{{ route('register.submit') }}">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name" id="name" placeholder="Nama lengkap"
                    class="w-full px-4 py-2 border bg-white text-black border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
            ...
            <div class="mb-6 relative">
                ...
                <input type="password" name="password" id="password" placeholder="Password"
                    class="w-full px-4 py-2 border bg-white text-black border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 pr-10">
            ...
            <div class="mb-6 relative">
                ...
                <input type="password" name="password_confirmation" id="password_confirmation" placeholder="Konfirmasi Password"
                 ...
                 <!-- Toggle Eye for Confirmation -->
                <span id="toggleConfirm" class="absolute right-3 top-10 cursor-pointer text-gray-500">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                            d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
            ...
            <button type="submit" class="w-full bg-blue-700 text-white py-2 rounded shadow hover:bg-blue-500 transition">
                Daftar
            </button>
        </form>
    ...
    <script>
        function togglePasswordVisibility(inputId, iconId) {
            ...
            // Aktifkan toggle untuk dua input
            togglePasswordVisibility('password', 'togglePassword');
            togglePasswordVisibility('password_confirmation', 'toggleConfirm');
    </script>
